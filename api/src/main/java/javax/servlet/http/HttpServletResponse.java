...
public interface HttpServletResponse extends ServletResponse {
     ...
     * @throws IOException           If an input or output exception occurs
     * @throws IllegalStateException If the response was committed or if a partial URL is given and cannot be
     ...
     * @throws IllegalStateException if it is invoked after the response has has been committed, or the trailer is
