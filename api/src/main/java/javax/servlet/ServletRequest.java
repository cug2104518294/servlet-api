 ...
 * The servlet container creates a ServletRequest object and passes it as an argument to the servlet's <code>service</code> method.
 *
 * <p>
...
public interface ServletRequest {
     ...
     * @throws UnsupportedEncodingException if the character set encoding used is not supported and the text cannot
     *                                      be decoded
